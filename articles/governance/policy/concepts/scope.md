...
- **Subscription** - The subscription where policy id defined and resources within that subscription can be assigned the policy definition.
- **Management group** - The management group where the policy id defined and resources within child management groups and child subscriptions can
